...
#define CUSTOM_MACHINE_NAME "IKM Kossel"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define R_FACTOR 2.47
    #define A_FACTOR 0.86
  #endif
  ...
  #define DELTA_HEIGHT 331.36 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ {-0.814,0.0,-0.456} // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 97.99 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM {-0.181,-0.134,0.316} // get these values from auto calibrate

  // delta radius and diaginal rod adjustments measured in mm
  //#define DELTA_RADIUS_TRIM_TOWER { 0.0, 0.0, 0.0 }
  //#define DELTA_DIAGONAL_ROD_TRIM_TOWER { -0.024, 0.291, 0.267 }
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 96 }   // default steps per unit for PowerWasp
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -20.5     // Z probe to nozzle Z offset: -below (always!)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION DELTA_PROBEABLE_RADIUS - 20
