...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 97.99             // (mm) Get this value from G33 auto calibrate
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 331.36             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ {-0.814,0.0,-0.456} // Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM {-0.181,-0.134,0.316} // Get these values from G33 auto calibrate
...
//#define Z_PROBE_END_SCRIPT "G1 Z30 X0 Y0 F6000\nG1 Z" STRINGIFY((DELTA_HEIGHT) - 30)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -90, -50, 30 }
